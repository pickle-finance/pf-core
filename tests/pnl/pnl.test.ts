...
import { UserJarHistoryPnlGenerator, weiToTokensWithPrecission } from "../../src/client/pnl/UserHistoryPnlGenerator";
...
describe("Testing Single Deposit", () => {
  test("basic", async () => {
    const summarized: PnlTransactionWrapper[] = new UserJarHistoryPnlGenerator("0xfeedc450742ac0d9bb38341d9939449e3270f76f", SIMPLE_DEPOSIT_ONLY_NO_RATIO_CHANGE.test).generatePnL();
...
describe("Testing Single Generated Deposit", () => {
  test("basic", async () => {
    ...
    const summarized2: PnlTransactionWrapper[] = new UserJarHistoryPnlGenerator(ADDRESS_ARRAY[ADDRESS_KEYS.USER], [tx]).generatePnL();
...
describe("Testing Two Deposits Same Price", () => {
  test("basic", async () => {
    ...
    const summarized2: PnlTransactionWrapper[] = new UserJarHistoryPnlGenerator(ADDRESS_ARRAY[ADDRESS_KEYS.USER], [tx, tx2]).generatePnL();
    const summarized: PnlRollingDataWithLots[] = summarized2.map((x) => x.pnlRollingDataWithLots);
...
describe("Testing One Deposit Two Withdraws Same Price", () => {
  test("basic", async () => {
    ...
    const summarized2: PnlTransactionWrapper[] = new UserJarHistoryPnlGenerator(ADDRESS_ARRAY[ADDRESS_KEYS.USER],[tx, tx2, tx3]).generatePnL();
    const summarized: PnlRollingDataWithLots[] = summarized2.map((x) => x.pnlRollingDataWithLots);
...
describe("Testing Two Deposits Two Withdraws Same Price Unmatched Lots", () => {
  test("basic", async () => {
    ...
    const summarized2: PnlTransactionWrapper[] = new UserJarHistoryPnlGenerator(ADDRESS_ARRAY[ADDRESS_KEYS.USER],[tx, tx2, tx3, tx4]).generatePnL();
    const summarized: PnlRollingDataWithLots[] = summarized2.map((x) => x.pnlRollingDataWithLots);
...
describe("Testing Two Deposit One Stake Three Unstake One Withdraw Same Price Same Ratio", () => {
  test("basic", async () => {
    ...
    const summarized2: PnlTransactionWrapper[] = new UserJarHistoryPnlGenerator(ADDRESS_ARRAY[ADDRESS_KEYS.USER],[tx1, tx1a, tx2, tx3, tx3a, tx3b, tx4]).generatePnL();
    const summarized: PnlRollingDataWithLots[] = summarized2.map((x) => x.pnlRollingDataWithLots);
...
describe("Testing Two Deposit One Withdraw Different Prices Different Ratios", () => {
  test("basic", async () => {
    ...
    const summarized2: PnlTransactionWrapper[] = new UserJarHistoryPnlGenerator(ADDRESS_ARRAY[ADDRESS_KEYS.USER],[tx1, tx1a, tx4, tx4a]).generatePnL();
    const summarized: PnlRollingDataWithLots[] = summarized2.map((x) => x.pnlRollingDataWithLots);
