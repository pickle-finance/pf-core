...
import { Uni3MaticEth } from "./impl/univ3-matic-eth";
import { Uni3MaticUsdc } from "./impl/univ3-matic-usdc";
import { Uni3UsdcUsdt } from "./impl/univ3-usdc-usdt";
import { Uni3WbtcEth } from "./impl/univ3-wbtc-eth";
...
jarToBehavior.set(JAR_POLY_UNIV3_MATIC_ETH.id, new Uni3MaticEth());
jarToBehavior.set(JAR_POLY_UNIV3_MATIC_USDC.id, new Uni3MaticUsdc());
jarToBehavior.set(JAR_POLY_UNIV3_USDC_USDT.id, new Uni3UsdcUsdt());
jarToBehavior.set(JAR_POLY_UNIV3_WBTC_ETH.id, new Uni3WbtcEth());
