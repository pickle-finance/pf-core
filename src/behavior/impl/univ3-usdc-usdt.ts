...
export class Uni3UsdcUsdt extends AbstractJarBehavior {
  async getDepositTokenPrice(
    ...
    const pJarUSD =
      ...
      model.priceOfSync("usdt") * jarAmount1;
