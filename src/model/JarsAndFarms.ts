...
export const JAR_ARBITRUM_UNIV3_ETH_USDC_OLD: JarDefinition = {
  type: AssetType.JAR,
  id: "arbJar Ua",
...
JAR_DEFINITIONS.push(JAR_ARBITRUM_UNIV3_ETH_USDC_OLD);
...
export const JAR_OPTIMISM_ZIP_ETH_WBTC: JarDefinition = {
  type: AssetType.JAR,
  id: "opJar 1c",
  contract: "0x15Bfcf85551c3DdBbB94ED08B9bA194D301E690A",
  startBlock: 2456201,
  startTimestamp: 1642654490,
  depositToken: {
...
JAR_DEFINITIONS.push(JAR_OPTIMISM_ZIP_ETH_WBTC);
...
export const JAR_OPTIMISM_STAR_USDC_1: JarDefinition = {
  type: AssetType.JAR,
  id: "opJar 2c",
  contract: "0x704616361Bd379B67AF5d00EA8D0Fe16C311b7C7",
  startBlock: 21598001,
  startTimestamp: 1662072634,
  depositToken: {
    addr: "0xDecC0c09c3B5f6e92EF4184125D5648a66E35298",
    name: "STARGATE USDC",
    link: "https://stargate.finance/pool/USDC-Optimism/add",
...
JAR_DEFINITIONS.push(JAR_OPTIMISM_STAR_USDC_1);

export const JAR_OPTIMISM_UNIV3_ETH_WBTC: JarDefinition = {
  type: AssetType.JAR,
  id: "opJar U3a",
  contract: "0xc335740c951F45200b38C5Ca84F0A9663b51AEC6",
  startBlock: 13923147,
  startTimestamp: 1657070498,
  depositToken: {
...
JAR_DEFINITIONS.push(JAR_OPTIMISM_UNIV3_ETH_WBTC);
...
export const JAR_OPTIMISM_VELO_USDC_MAI_S: JarDefinition = {
  type: AssetType.JAR,
  id: "opJar 3l",
  contract: "0xCCa0596158cdce209d12A2163dCe49810B4548b9",
  startBlock: 21597301,
  startTimestamp: 1662072016,
  depositToken: {
...
JAR_DEFINITIONS.push(JAR_OPTIMISM_VELO_USDC_MAI_S);

export const JAR_OPTIMISM_VELO_USDC_SUSD_S: JarDefinition = {
  type: AssetType.JAR,
  id: "opJar 3m",
  contract: "0x7513A8878AFcce59021fc6AE62c1778c80d63eE5",
  startBlock: 21597352,
  startTimestamp: 1662072081,
  depositToken: {
...
JAR_DEFINITIONS.push(JAR_OPTIMISM_VELO_USDC_SUSD_S);

export const JAR_OPTIMISM_VELO_USDC_SNX_V: JarDefinition = {
  type: AssetType.JAR,
  id: "opJar 3n",
  contract: "0xcAde0c1C4C0c25cFDF62c26bb1A0D749d094F58A",
  startBlock: 21597451,
  startTimestamp: 1662072144,
  depositToken: {
...
JAR_DEFINITIONS.push(JAR_OPTIMISM_VELO_USDC_SNX_V);

export const JAR_OPTIMISM_VELO_ETH_SETH_S: JarDefinition = {
  type: AssetType.JAR,
  id: "opJar 3o",
  contract: "0x3BA3F80f0C689f73e7606B2A49806eAe72DFD5f7",
  startBlock: 21597503,
  startTimestamp: 1662072206,
  depositToken: {
...
JAR_DEFINITIONS.push(JAR_OPTIMISM_VELO_ETH_SETH_S);

export const JAR_OPTIMISM_VELO_ETH_ALETH_S: JarDefinition = {
  type: AssetType.JAR,
  id: "opJar 3p",
  contract: "0x1D9073254E23D90287110428EF2aCB392a55c303",
  startBlock: 21597538,
  startTimestamp: 1662072276,
  depositToken: {
...
export const JAR_OPTIMISM_VELO_ETH_RETH_V: JarDefinition = {
  type: AssetType.JAR,
  id: "opJar 3r",
  contract: "0xeda1F6C87DccAF65bB5027e29B86F1Db303906db",
  startBlock: 77087873,
  startTimestamp: 1677356165,
  depositToken: {
    addr: "0x985612ff2C9409174FedcFf23d4F4761AF124F88",
    name: "VELO ETH/RETH VLP",
    link: "https://app.velodrome.finance/liquidity/manage?address=0x985612ff2c9409174fedcff23d4f4761af124f88",
    components: ["eth", "reth"],
  },
  rewardTokens: ["velo"],
  enablement: AssetEnablement.ENABLED,
  ...
  protocol: AssetProtocol.VELODROME,
  details: {
    apiKey: "VELO-ETH-RETH-VLP",
    harvestStyle: HarvestStyle.PASSIVE,
    controller: "0xeEDeF926D3d7C9628c8620B5a018c102F413cDB7",
  },
  farm: {
    farmAddress: "0x849C283375A156A6632E8eE928308Fcb61306b7B",
    farmNickname: "pVELO ETH/RETH VLP",
    farmDepositTokenName: "pVELO ETH/RETH VLP",
  },
};
JAR_DEFINITIONS.push(JAR_OPTIMISM_VELO_ETH_RETH_V);

export const JAR_OPTIMISM_VELO_USDC_DOLA_S: JarDefinition = {
  type: AssetType.JAR,
  id: "opJar 3s",
  contract: "0x78227524C7c13b78D04B8EDABA192a16ef5Eb029",
  startBlock: 77638194,
  startTimestamp: 1677532674,
  depositToken: {
    addr: "0x6C5019D345Ec05004A7E7B0623A91a0D9B8D590d",
  ...
  protocol: AssetProtocol.VELODROME,
  details: {
    apiKey: "VELO-USDC-DOLA-SLP",
    harvestStyle: HarvestStyle.PASSIVE,
    controller: "0xeEDeF926D3d7C9628c8620B5a018c102F413cDB7",
  },
  farm: {
    farmAddress: "0x849C283375A156A6632E8eE928308Fcb61306b7B",
    farmNickname: "pVELO USDC/DOLA SLP",
    farmDepositTokenName: "pVELO USDC/DOLA SLP",
  },
};
JAR_DEFINITIONS.push(JAR_OPTIMISM_VELO_USDC_DOLA_S);

export const JAR_OPTIMISM_VELO_USDC_DAI_S: JarDefinition = {
  type: AssetType.JAR,
  id: "opJar 3t",
  contract: "0xc2d0035298aB7411F033cCf20599a703CaD013bC",
  startBlock: 77638268,
  startTimestamp: 1677532734,
  depositToken: {
    addr: "0x4F7ebc19844259386DBdDB7b2eB759eeFc6F8353",
    name: "VELO USDC/DAI SLP",
    link: "https://app.velodrome.finance/liquidity/manage?address=0x4f7ebc19844259386dbddb7b2eb759eefc6f8353",
    components: ["usdc", "dai"],
  },
  rewardTokens: ["velo"],
  enablement: AssetEnablement.ENABLED,
  ...
  protocol: AssetProtocol.VELODROME,
  details: {
    apiKey: "VELO-USDC-DAI-SLP",
    harvestStyle: HarvestStyle.PASSIVE,
    controller: "0xeEDeF926D3d7C9628c8620B5a018c102F413cDB7",
  },
  farm: {
    farmAddress: "0x849C283375A156A6632E8eE928308Fcb61306b7B",
    farmNickname: "pVELO USDC/DAI SLP",
    farmDepositTokenName: "pVELO USDC/DAI SLP",
  },
};
JAR_DEFINITIONS.push(JAR_OPTIMISM_VELO_USDC_DAI_S);

export const JAR_OPTIMISM_VELO_STETH_SETH_S: JarDefinition = {
  type: AssetType.JAR,
  id: "opJar 3u",
  contract: "0x2292077247e15f28dDdEc94c9BA9B4875990B8A8",
  startBlock: 77638367,
  startTimestamp: 1677532779,
  depositToken: {
    addr: "0xB343dae0E7fe28c16EC5dCa64cB0C1ac5F4690AC",
    name: "VELO STETH/SETH SLP",
    link: "https://app.velodrome.finance/liquidity/manage?address=0xb343dae0e7fe28c16ec5dca64cb0c1ac5f4690ac",
    components: ["steth", "seth"],
  },
  rewardTokens: ["velo"],
  enablement: AssetEnablement.ENABLED,
  chain: ChainNetwork.Optimism,
  protocol: AssetProtocol.VELODROME,
  details: {
    apiKey: "VELO-STETH-SETH-SLP",
    harvestStyle: HarvestStyle.PASSIVE,
    controller: "0xeEDeF926D3d7C9628c8620B5a018c102F413cDB7",
  },
  farm: {
    farmAddress: "0x849C283375A156A6632E8eE928308Fcb61306b7B",
    farmNickname: "pVELO STETH/SETH SLP",
    farmDepositTokenName: "pVELO STETH/SETH SLP",
  },
};
JAR_DEFINITIONS.push(JAR_OPTIMISM_VELO_STETH_SETH_S);

export const JAR_OPTIMISM_VELO_STETH_ETH_V: JarDefinition = {
  type: AssetType.JAR,
  id: "opJar 3v",
  contract: "0xd0A77bD4daF7d65E9c4967dd35fd2DD3a333E621",
  startBlock: 77638447,
  ...
  farm: {
    farmAddress: "0x849C283375A156A6632E8eE928308Fcb61306b7B",
    farmNickname: "pVELO STETH/ETH VLP",
    farmDepositTokenName: "pVELO STETH/ETH VLP",
  },
};
