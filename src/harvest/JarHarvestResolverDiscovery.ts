...
jarToHarvestResolver.set( JAR_QUICK_QI_MIMATIC.details.apiKey, new MimaticQi());
jarToHarvestResolver.set( JAR_IRON3USD.details.apiKey, new Is3Usd());
jarToHarvestResolver.set( JAR_QUICK_DINO_ETH.details.apiKey, new DinoEth());
