...
interface MinichefInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "picklePerSecond",
    values?: undefined,
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setPicklePerSecond",
    values: [BigNumberish],
  ): string;
  encodeFunctionData(
...
export class Minichef extends Contract {
  ...
  filters: {
    ...
    LogPicklePerSecond(
      picklePerSecond: null,
    ): TypedEventFilter<[BigNumber], { picklePerSecond: BigNumber }>;
