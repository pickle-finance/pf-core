...
interface CurveFactoryGaugeInterface extends ethers.utils.Interface {
  functions: {
...
export class CurveFactoryGauge extends Contract {
  ...
  interface: CurveFactoryGaugeInterface;
