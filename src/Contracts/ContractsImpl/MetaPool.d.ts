...
interface MetaPoolInterface extends ethers.utils.Interface {
  functions: {
...
export class MetaPool extends Contract {
  ...
  filters: {
    ...
    NewAdminFee(
      newAdminFee: null
    ): TypedEventFilter<[BigNumber], { newAdminFee: BigNumber }>;
    ...
    NewWithdrawFee(
      newWithdrawFee: null
    ): TypedEventFilter<[BigNumber], { newWithdrawFee: BigNumber }>;
