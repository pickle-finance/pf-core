...
interface CurveFactoryInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "set_token_implementation",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "get_eth_index",
    values: [string]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "pool_implementation",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class CurveFactory extends Contract {
  ...
  filters: {
    ...
    LiquidityGaugeDeployed(
      ...
      { pool: string; token: string; gauge: string }
    >;
    ...
    UpdateFeeReceiver(
      ...
      [string, string],
      { _old_fee_receiver: string; _new_fee_receiver: string }
    >;
    ...
    UpdatePoolImplementation(
      ...
      [string, string],
      { _old_pool_implementation: string; _new_pool_implementation: string }
    >;
    ...
    UpdateTokenImplementation(
      ...
      [string, string],
      { _old_token_implementation: string; _new_token_implementation: string }
    >;
    ...
    UpdateGaugeImplementation(
      ...
      [string, string],
      { _old_gauge_implementation: string; _new_gauge_implementation: string }
    >;
    ...
    TransferOwnership(
      ...
      [string, string],
      { _old_owner: string; _new_owner: string }
    >;
  };
