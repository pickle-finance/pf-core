...
import type { FeeDistributorV2 } from "../FeeDistributorV2";

export class FeeDistributorV2__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): FeeDistributorV2 {
    return new Contract(address, _abi, signerOrProvider) as FeeDistributorV2;
  }
}
