...
import type { StrategyV2 } from "../StrategyV2";

export class StrategyV2__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): StrategyV2 {
    return new Contract(address, _abi, signerOrProvider) as StrategyV2;
  }
}
    ...
    inputs: [
      {
        ...
        internalType: "struct RouteParams[]",
        name: "path",
        type: "tuple[]",
      },
    ],
