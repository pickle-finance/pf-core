...
import type { CurveFactoryGauge } from "../CurveFactoryGauge";

export class CurveFactoryGauge__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CurveFactoryGauge {
    return new Contract(address, _abi, signerOrProvider) as CurveFactoryGauge;
  }
}
