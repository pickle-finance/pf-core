...
import type { LqdrFarm } from "../LqdrFarm";

export class LqdrFarm__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LqdrFarm {
    return new Contract(address, _abi, signerOrProvider) as LqdrFarm;
  }
}
...
const _abi = [
  ...
  {
    inputs: [],
    name: "MASTERCHEF_LQDR_PER_BLOCK",
    outputs: [
      {
        internalType: "uint256",
        name: "",
