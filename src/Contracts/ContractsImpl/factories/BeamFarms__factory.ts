...
import type { BeamFarms } from "../BeamFarms";

export class BeamFarms__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BeamFarms {
    return new Contract(address, _abi, signerOrProvider) as BeamFarms;
  }
}
