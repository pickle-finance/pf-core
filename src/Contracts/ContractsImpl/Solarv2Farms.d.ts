...
interface Solarv2FarmsInterface extends ethers.utils.Interface {
  functions: {
...
export class Solarv2Farms extends Contract {
  ...
  interface: Solarv2FarmsInterface;
  ...
  functions: {
    ...
    solarPerSec(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    solarPerSec(overrides?: CallOverrides): Promise<PopulatedTransaction>;
