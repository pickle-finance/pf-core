...
interface FeeDistributorV2Interface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "total_eth_received",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "eth_last_balance",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class FeeDistributorV2 extends Contract {
  ...
  interface: FeeDistributorV2Interface;
  ...
  callStatic: {
    ...
    "burn(address)"(_coin: string, overrides?: CallOverrides): Promise<boolean>;
  ...
  filters: {
    CommitAdmin(admin: null): TypedEventFilter<[string], { admin: string }>;
    ...
    EtherSent(
      ...
      [BigNumber, string],
      { amount: BigNumber; sender: string }
    >;
  };
