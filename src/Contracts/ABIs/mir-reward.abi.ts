export const mirRewardAbi = [
  {
    inputs: [
      { internalType: 'address', name: '_mir', type: 'address' },
      { internalType: 'address', name: '_lpt', type: 'address' },
  ...
  { inputs: [], name: 'notifyReward', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
    name: 'owner',
