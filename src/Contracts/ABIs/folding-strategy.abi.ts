export const foldingStrategyAbi = [
  {
    inputs: [
  ...
  { inputs: [], name: 'deleverageToMin', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [{ internalType: 'uint256', name: '_supplyAmount', type: 'uint256' }],
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'supplyBalance', type: 'uint256' }],
  ...
  { inputs: [], name: 'leverageToMax', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [{ internalType: 'uint256', name: '_supplyAmount', type: 'uint256' }],
    name: 'leverageUntil',
    outputs: [],
  ...
  {
    inputs: [{ internalType: 'address[]', name: '_harvesters', type: 'address[]' }],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_colFactorLeverageBuffer', type: 'uint256' }],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_performanceDevFee', type: 'uint256' }],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_performanceTreasuryFee', type: 'uint256' }],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_withdrawalDevFundFee', type: 'uint256' }],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_withdrawalTreasuryFee', type: 'uint256' }],
  ...
  {
    inputs: [{ internalType: 'contract IERC20', name: '_asset', type: 'address' }],
    name: 'withdraw',
