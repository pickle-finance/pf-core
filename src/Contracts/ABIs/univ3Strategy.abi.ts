export const univ3StrategyABI = [
  ...
  },
  {
    ...
    outputs: [{ internalType: "bool", name: "stakingActive", type: "bool" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  {
    inputs: [{ internalType: "uint24", name: "_twapTime", type: "uint24" }],
    name: "setTwapTime",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  },
  {
    ...
    name: "withdraw",
    outputs: [
      { internalType: "uint256", name: "a0", type: "uint256" },
