...
import { ALL_ASSETS, JAR_UNIV3_FRAX_DAI, JAR_UNIV3_RBN_ETH } from "./model/JarsAndFarms";
...
async function generateFullApi() {
  ...
  const model : PickleModel = new PickleModel([JAR_UNIV3_FRAX_DAI, JAR_UNIV3_RBN_ETH], map);
