...
export class ExternalTokenModel {
  ...
  constructor() {
    ...
    this.addToken(ChainNetwork.Aurora, "eth", "ethereum", "0xC9BdeEd33CD01541e1eeD10f90519d2C06Fe3feB".toLowerCase(), 18, ExternalTokenFetchStyle.ID);
    ...
    this.addToken(ChainNetwork.Aurora, "pad", "nearpad", "0x885f8CF6E45bdd3fdcDc644efdcd0AC93880c781".toLowerCase(), 18, ExternalTokenFetchStyle.ID);
    ...
    this.addToken(ChainNetwork.Metis, "usdc", "usd-coin", "0xEA32A96608495e54156Ae48931A7c20f0dcc1a21".toLowerCase(), 18, ExternalTokenFetchStyle.ID);
    this.addToken(ChainNetwork.Metis, "usdt", "tether", "0xbB06DCA3AE6887fAbF931640f67cab3e3a16F4dC".toLowerCase(), 18, ExternalTokenFetchStyle.ID);
