...
export interface IPriceResolver {
     ...
     */
    getOrResolve(ids: string[], cache: PriceCache): Promise<Map<string,number>> | null;
     ...
     * @param cache 
     */
    getPriceComponents(ids: string[], cache: PriceCache): Promise<Map<string,IPriceComponents>>;
}